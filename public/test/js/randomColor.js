...
var newColor2;
function setColor() {
    newColor1 = materialColor();
    newColor2 = randomColor();
}

function setRanColor() {
    var collection = document.getElementsByClassName('c_img');
    for (var i = 0; i < collection.length; ++i) {
        setColor()
        collection[i].style.background = newColor1;
        collection[i].style.color = newColor2;
    }
}